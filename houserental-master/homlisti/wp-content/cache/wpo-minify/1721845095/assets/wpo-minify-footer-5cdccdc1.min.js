...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.radiustheme.com/demo/wordpress/themes/homlisti/wp-content/plugins/fluentform/assets/js/form-submission.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.radiustheme.com/demo/wordpress/themes/homlisti/wp-content/plugins/fluentform/assets/js/fluentform-advanced.js\n- Error message: "+ e.message);}

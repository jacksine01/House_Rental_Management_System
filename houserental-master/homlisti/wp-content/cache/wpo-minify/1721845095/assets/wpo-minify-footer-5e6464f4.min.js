...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.radiustheme.com/demo/wordpress/themes/homlisti/wp-content/plugins/homlisti-core/assets/js/pannellum.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.radiustheme.com/demo/wordpress/themes/homlisti/wp-content/plugins/classified-listing-pro/assets/js/rtcl-chat.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.radiustheme.com/demo/wordpress/themes/homlisti/wp-content/plugins/review-schema/assets/js/app.min.js\n- Error message: "+ e.message);}
